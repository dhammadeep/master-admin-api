...
use App\Http\Masters\Geo\Services\CountryService;
...
class CountryController extends Controller
{
     ...
     * @return Void
     */
    public function __construct(CountryService $service, Country $country)
    {
        ...
        try {
            $data = [
                'formData' => [
                    ...
                    'formStoreUrl' => $this->baseUrl . 'geo/country',
                ],
     ...
     *
     * @link http://geo/country/update/id
     *
     * @method PATCH/PUT
     *
    ...
    */
    public function import(BulkInsertRequest $bulkInsertRequest)
    {
        ...
        try {
            ...
            $validation = [
                'name' => 'required|unique:geo_country,name',
                'iso2' => 'required',
            ];
            ...
            if (!empty($diff)) {
                ...
                $import = new CustomImportsService($this->country, $validation);
                $import->import($file);
            }
        } catch (ValidationException $e) {
            $code = "DATA_NOT_FOUND";
            $collection = (new CustomImportsService($this->country, []))->toCollection($file);
            $failures = $e->failures();
            $fileName = $this->country->getTable() . '_error.xlsx';
            Excel::store(
