...
use App\Http\Masters\Geo\Services\DistrictService;
...
class DistrictController extends Controller
{
    ...
    */
     ...
     * @return Void
     */
    public function __construct(DistrictService $service, District $district)
    {
     ...
     *
     *@link http://api/v1/geo/district/create/
     *
     *@method GET
     *
     * @return Response
    ...
    public function create()
    {
        ...
        try{
             $data = [
                'formData' => [
                    //'type' => 'Add',
                    //'title' => 'Add Geographical District',
                    'fields' => $this->service->getFormFields(),
                    'formStoreUrl' => $this->baseUrl . 'geo/district',
                ],
     ...
     *
     *@link http://api/v1/geo/district/store
     *
     *@method POST
     *
     ...
     *
     *@link http://api/v1/geo/district/edit/id
     *
     *@method GET
     *
     * @return Response
    ...
    public function edit(int $id)
    {
        ...
        $code = "SUCCESS";
        try {
            $tableData = $this->service->findDistrictById($id);
            ...
            $data =  [
                ...
                // 'type' => 'Edit',
                // 'methodName' => 'PUT',
                // 'title' => 'Geographical District',
                   'fields' => $data,
                   'formStoreUrl' => "{$this->baseUrl}geo/district/$id",
                ]
            ];
        } catch (AuthenticationException $e) {
            $code = "HTTP_AUTHENTICATION_ERROR";
     ...
     *
     *@link http://api/v1/geo/district/update/id
     *
     *@method PATCH/PUT
     *
    ...
    */
    public function import(BulkInsertRequest $bulkInsertRequest)
    {
        ...
        try {
            ...
            $validation = [
                'name' => 'required|unique:geo_district,name',
            ...
            if (!empty($diff)) {
                ...
                $import = new CustomImportsService($this->district, $validation);
                $import->import($file);
            }
        } catch (ValidationException $e) {
            $code = "DATA_NOT_FOUND";
            $collection = (new CustomImportsService($this->district, []))->toCollection($file);
            $failures = $e->failures();
            $fileName = $this->district->getTable() . '_error.xlsx';
            Excel::store(
            ...
            $path = url("{$version_url}geo/district/download/{$fileName}");
            // return an error
            $bulkInsert = $this->service->getBulkInsertFormFields();
