...
use App\Http\Masters\Geo\Services\ContinentService;
...
class ContinentController extends Controller
{
    ...
    */
    ...
    /**
     * Injects Continent Service dependency through the constructor
     *
     * @param ContinentService $service
     *
     * @return Void
     */
    public function __construct(ContinentService $service,Continent $continent)
    {
     ...
     *
     *@link http://api/v1/geo/continent
     *
     *@method GET
     *
    ...
    /**
     * Displays a form to add new Continent
     *
     *@link http://api/v1/geo/continent/create/
     *
     *@method GET
     *
     * @return Response
    ...
    public function create()
    {
        ...
        try{
             $data = [
                'formData' => [
                    //'type' => 'Add',
                    //'title' => 'Add Geographical Continent',
                    'fields' => $this->service->getFormFields(),
                    'formStoreUrl' => $this->baseUrl . 'geo/continent',
                ],
     ...
     *
     *@link http://api/v1/geo/continent/store
     *
     *@method POST
     *
    ...
    public function store(ContinentRequest $request)
    {
     ...
     /**
     * Displays a form with values to update Continent
     *
     *@link http://api/v1/geo/continent/edit/id
     *
     *@method GET
     *
     * @return Response
    ...
    public function edit(int $id)
    {
        ...
        $code = "SUCCESS";
        try {
            $tableData = $this->service->findContinentById($id);
            ...
            $data =  [
                ...
                // 'type' => 'Edit',
                // 'methodName' => 'PUT',
                // 'title' => 'Geographical Continent',
                   'fields' => $data,
                   'formStoreUrl' => "{$this->baseUrl}geo/continent/$id",
                ]
            ];
        } catch (AuthenticationException $e) {
            $code = "HTTP_AUTHENTICATION_ERROR";
     ...
     *
     *@link http://api/v1/geo/continent/update/id
     *
     *@method PATCH/PUT
     *
     * @param ContinentRequest  $request The request object
    ...
    */
    public function import(BulkInsertRequest $bulkInsertRequest)
    {
        ...
        try {
            ...
            $validation = [
                'name' => 'required|unique:geo_continent,name',
                'code' => 'required',
            ];
            ...
            if (!empty($diff)) {
                ...
                $import = new CustomImportsService($this->continent, $validation);
                $import->import($file);
            }
        } catch (ValidationException $e) {
            $code = "DATA_NOT_FOUND";
            $collection = (new CustomImportsService($this->continent, []))->toCollection($file);
            $failures = $e->failures();
            $fileName = $this->continent->getTable() . '_error.xlsx';
            Excel::store(
            ...
            $path = url("{$version_url}geo/continent/download/{$fileName}");
            // return an error
            $bulkInsert = $this->service->getBulkInsertFormFields();
