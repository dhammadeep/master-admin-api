...
use App\Http\Masters\Geo\Services\CityService;
...
class CityController extends Controller
{
    ...
    */
    ...
    /**
     * Injects City Service dependency through the constructor
     *
     * @param CityService $service
     *
     * @return Void
     */
    public function __construct(CityService $service, City $city)
    {
    ...
    /**
     * Displays a form to add new City
     *
     *@link http://api/v1/geo/city/create/
     *
     *@method GET
     *
     * @return Response
    ...
    public function create()
    {
        ...
        try{
             $data = [
                'formData' => [
                    //'type' => 'Add',
                    //'title' => 'Add Geographical City',
                    'fields' => $this->service->getFormFields(),
                    'formStoreUrl' => $this->baseUrl . 'geo/city',
                ],
     ...
     *
     *@link http://api/v1/geo/city/store
     *
     *@method POST
     *
    ...
    public function store(CityRequest $request)
    {
     ...
     /**
     * Displays a form with values to update City
     *
     *@link http://api/v1/geo/city/edit/id
     *
     *@method GET
     *
     * @return Response
    ...
    public function edit(int $id)
    {
        ...
        $code = "SUCCESS";
        try {
            $tableData = $this->service->findCityById($id);
            ...
            $data =  [
                ...
                // 'type' => 'Edit',
                // 'methodName' => 'PUT',
                // 'title' => 'Geographical City',
                   'fields' => $data,
                   'formStoreUrl' => "{$this->baseUrl}geo/city/$id",
                ]
            ];
        } catch (AuthenticationException $e) {
            $code = "HTTP_AUTHENTICATION_ERROR";
     ...
     *
     *@link http://api/v1/geo/city/update/id
     *
     *@method PATCH/PUT
     *
     * @param CityRequest  $request The request object
    ...
    */
    public function import(BulkInsertRequest $bulkInsertRequest)
    {
        ...
        try {
            ...
            $validation = [
                'name' => 'required|unique:geo_city,name',
                'state_id\.geo_state\.name' => 'required|exists:geo_state,name',
                'district_id\.geo_district\.name' => 'required|exists:geo_district,name'
            ];
            ...
            if (!empty($diff)) {
                ...
                $import = new CustomImportsService($this->city, $validation);
                $import->import($file);
            }
        } catch (ValidationException $e) {
            $code = "DATA_NOT_FOUND";
            $collection = (new CustomImportsService($this->city, []))->toCollection($file);
            $failures = $e->failures();
            $fileName = $this->city->getTable() . '_error.xlsx';
            Excel::store(
