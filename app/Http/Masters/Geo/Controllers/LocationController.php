...
use App\Http\Masters\Geo\Services\LocationService;
...
class LocationController extends Controller
{
    ...
    */
    private string $baseUrl = "/api/v1/geo/location";

    /**
     * Injects Location Service dependency through the constructor
     *
    ...
    /**
     * Displays a form to add new Location
     *
     *@link http://api/v1/geo/location/create/
     *
     *@method GET
     *
     * @return Response
    ...
    public function create()
    {
        ...
        try{
             $data = [
                'formData' => [
                    //'type' => 'Add',
                    //'title' => 'Add Geographical Location',
                    'fields' => $this->service->getFormFields(),
                    'formStoreUrl' => $this->baseUrl . '/store',
                ],
     ...
     *
     *@link http://api/v1/geo/location/store
     *
     *@method POST
     *
    ...
    public function store(LocationRequest $request)
    {
     ...
     /**
     * Displays a form with values to update Location
     *
     *@link http://api/v1/geo/location/edit/id
     *
     *@method GET
     *
     * @return Response
    ...
    public function edit(int $id)
    {
        ...
        $code = "SUCCESS";
        try {
            $tableData = $this->service->findLocationById($id);
     ...
     *
     *@link http://api/v1/geo/location/update/id
     *
     *@method PATCH/PUT
     *
     * @param LocationRequest  $request The request object
