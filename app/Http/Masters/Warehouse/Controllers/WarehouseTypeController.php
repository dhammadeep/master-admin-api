...
use App\Http\Masters\Warehouse\Services\WarehouseTypeService;
...
class WarehouseTypeController extends Controller
{
    ...
    */
    ...
    /**
     * Injects WarehouseType Service dependency through the constructor
     *
     * @param WarehouseTypeService $service
     *
     * @return Void
     */
    public function __construct(WarehouseTypeService $service)
    {
     ...
     *
     *@link http://api/v1/warehouse/warehouse-type
     *
     *@method GET
     *
    ...
    /**
     * Displays a form to add new WarehouseType
     *
     *@link http://api/v1/warehouse/warehouse-type/create/
     *
     *@method GET
     *
     * @return Response
    ...
    public function create()
    {
        ...
        try{
             $data = [
                'formData' => [
                    //'type' => 'Add',
                    //'title' => 'Add Warehouse Type',
                    'fields' => $this->service->getFormFields(),
                    'formStoreUrl' => $this->baseUrl . 'warehouse/warehouse-type/store',
                ],
     ...
     *
     *@link http://api/v1/warehouse/warehouse-type/store
     *
     *@method POST
     *
    ...
    public function store(WarehouseTypeRequest $request)
    {
     ...
     /**
     * Displays a form with values to update WarehouseType
     *
     *@link http://api/v1/warehouse/warehouse-type/edit/id
     *
     *@method GET
     *
     * @return Response
    ...
    public function edit(int $id)
    {
        ...
        $code = "SUCCESS";
        try {
            $tableData = $this->service->findWarehouseTypeById($id);
            ...
            $data =  [
                ...
                // 'title' => 'Warehouse Type',
                   'fields' => $data,
                   'formStoreUrl' => "{$this->baseUrl}warehouse/warehouse-type/$id",
                ]
            ];
        } catch (AuthenticationException $e) {
            $code = "HTTP_AUTHENTICATION_ERROR";
     ...
     *
     *@link http://api/v1/warehouse/warehouse-type/update/id
     *
     *@method PATCH/PUT
     *
     * @param WarehouseTypeRequest  $request The request object
