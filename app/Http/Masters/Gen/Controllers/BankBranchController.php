...
use App\Http\Masters\Gen\Services\BankBranchService;
...
class BankBranchController extends Controller
{
    ...
    */
     ...
     * @return Void
     */
    public function __construct(BankBranchService $service,BankBranch $bankBranch)
    {
     ...
     *
     *@link http://api/v1/gen/bank-branch
     *
     *@method GET
     *
     ...
     *
     *@link http://api/v1/gen/bank-branch/create/
     *
     *@method GET
     *
     * @return Response
    ...
    public function create()
    {
        ...
        try{
             $data = [
                'formData' => [
                    //'type' => 'Add',
                    //'title' => 'Add General Bank Branch',
                    'fields' => $this->service->getFormFields(),
                    'formStoreUrl' => $this->baseUrl . 'gen/bank-branch',
                ],
     ...
     *
     *@link http://api/v1/gen/bank-branch/store
     *
     *@method POST
     *
     ...
     *
     *@link http://api/v1/gen/bank-branch/edit/id
     *
     *@method GET
     *
     * @return Response
    ...
    public function edit(int $id)
    {
        ...
        $code = "SUCCESS";
        try {
            $tableData = $this->service->findBankBranchById($id);
            ...
            $data =  [
                ...
                // 'type' => 'Edit',
                // 'methodName' => 'PUT',
                // 'title' => 'General Bank Branch',
                   'fields' => $data,
                   'formStoreUrl' => "{$this->baseUrl}gen/bank-branch/$id",
                ]
            ];
        } catch (AuthenticationException $e) {
            $code = "HTTP_AUTHENTICATION_ERROR";
     ...
     *
     *@link http://api/v1/gen/bank-branch/update/id
     *
     *@method PATCH/PUT
     *
    ...
    public function approve(Request $request)
    {
     ...
     /**
     * updateStatus the status in list
     *
     * @param Request $request The request object
     *
     * @return request
    ...
    */
    public function import(BulkInsertRequest $bulkInsertRequest)
    {
        ...
        try {
            ...
            $validation = [
                'name' => 'required|unique:gen_bank,name',
                'bank_id\.gen_bank\.name' => 'required|exists:gen_bank,name',
                'ifsc' => 'required'
            ];
            ...
            if (!empty($diff)) {
                ...
                $import = new CustomImportsService($this->bankBranch, $validation);
                $import->import($file);
            }
        } catch (ValidationException $e) {
            $code = "DATA_NOT_FOUND";
            $collection = (new CustomImportsService($this->bankBranch, []))->toCollection($file);
            $failures = $e->failures();
            $fileName = $this->bankBranch->getTable() . '_error.xlsx';
            Excel::store(
            ...
            $path = url("{$version_url}geo/state/download/{$fileName}");
            // return an error
            $bulkInsert = $this->service->getBulkInsertFormFields();
