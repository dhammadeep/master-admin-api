...
use App\Http\Masters\Gen\Services\RejectionReasonTypeService;
use Symfony\Component\HttpKernel\Exception\NotFoundHttpException;
use Symfony\Component\HttpFoundation\Exception\BadRequestException;

class RejectionReasonTypeController extends Controller
{
    protected $service,$rejectionReasonType;
    ...
    */
    ...
    /**
     * Injects RejectionReasonType Service dependency through the constructor
     *
     * @param RejectionReasonTypeService $service
     *
     * @return Void
     */
    public function __construct(RejectionReasonTypeService $service,RejectionReasonType $rejectionReasonType)
    {
     ...
     *
     *@link http://api/v1/gen/rejection-reasons-type
     *
     *@method GET
     *
    ...
    /**
     * Displays a form to add new RejectionReasonType
     *
     *@link http://api/v1/gen/rejection-reasons-type/create/
     *
     *@method GET
     *
     * @return Response
    ...
    public function create()
    {
        ...
        try{
             $data = [
                'formData' => [
                    //'type' => 'Add',
                    //'title' => 'Add General Rejection Reason Type',
                    'fields' => $this->service->getFormFields(),
                    'formStoreUrl' => $this->baseUrl . 'gen/rejection-reasons-type',
                ],
     ...
     *
     *@link http://api/v1/gen/rejection-reasons-type/store
     *
     *@method POST
     *
     ...
     */
    public function store(RejectionReasonTypeRequest $request)
    {
        $data = null;
        $code = "SUCCESS";
        try {
     ...
     /**
     * Displays a form with values to update RejectionReasonType
     *
     *@link http://api/v1/gen/rejection-reasons-type/edit/id
     *
     *@method GET
     *
     * @return Response
    ...
    public function edit(int $id)
    {
        ...
        $code = "SUCCESS";
        try {
            $tableData = $this->service->findRejectionReasonTypeById($id);
            ...
            $data =  [
                ...
                // 'type' => 'Edit',
                // 'methodName' => 'PUT',
                // 'title' => 'General Rejection Reason Type',
                   'fields' => $data,
                   'formStoreUrl' => "{$this->baseUrl}gen/rejection-reasons-type/$id",
                ]
            ];
        } catch (AuthenticationException $e) {
            $code = "HTTP_AUTHENTICATION_ERROR";
     ...
     *
     *@link http://api/v1/gen/rejection-reasons-type/update/id
     *
     *@method PATCH/PUT
     *
     * @param RejectionReasonTypeRequest  $request The request object
    ...
    */
    public function import(BulkInsertRequest $bulkInsertRequest)
    {
        ...
        try {
            ...
            $validation = [
                'name' => 'required|unique:gen_rejection_reason_type,name'
            ];
            ...
            if (!empty($diff)) {
                ...
                $import = new CustomImportsService($this->rejectionReasonType, $validation);
                $import->import($file);
            }
        } catch (ValidationException $e) {
            $code = "DATA_NOT_FOUND";
            $collection = (new CustomImportsService($this->rejectionReasonType, []))->toCollection($file);
            $failures = $e->failures();
            $fileName = $this->rejectionReasonType->getTable() . '_error.xlsx';
            Excel::store(
