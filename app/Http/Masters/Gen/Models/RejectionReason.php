...
class RejectionReason extends Model
{
     ...
     * @var string
     */
    protected $table = 'gen_rejection_reason';
    ...
    protected static $tableFields = [
        ...
        [
            ...
            'type' => 'text',
            'tableField' => 'rejection_reason_type_id'
        ],
        [
            'name' => 'status',
            'type' => 'badge',
     ...
     * @return object
     */
    public function rejectionReasonType()
    {
        return $this->belongsTo(
            related: RejectionReasonType::class,
            foreignKey: 'rejection_reason_type_id',
            ownerKey: 'id'
        );
    }
