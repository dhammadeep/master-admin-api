...
use App\Http\Masters\Agri\Services\CropTypeService;
...
class CropTypeController extends Controller
{
    ...
    */
    ...
    /**
     * Injects CropType Service dependency through the constructor
     *
     * @param CropTypeService $service
     *
     * @return Void
     */
    public function __construct(CropTypeService $service,CropType $cropType)
    {
     ...
     *
     *@link http://api/v1/agri/crop-type
     *
     *@method GET
     *
    ...
    /**
     * Displays a form to add new CropType
     *
     *@link http://api/v1/agri/crop-type/create/
     *
     *@method GET
     *
     * @return Response
    ...
    public function create()
    {
        ...
        try{
             $data = [
                'formData' => [
                    //'type' => 'Add',
                    //'title' => 'Add Agriculture Crop Type',
                    'fields' => $this->service->getFormFields(),
                    'formStoreUrl' => $this->baseUrl . 'agri/crop-type',
                ],
     ...
     *
     *@link http://api/v1/agri/crop-type/store
     *
     *@method POST
     *
    ...
    public function store(CropTypeRequest $request)
    {
     ...
     /**
     * Displays a form with values to update CropType
     *
     *@link http://api/v1/agri/crop-type/edit/id
     *
     *@method GET
     *
     * @return Response
    ...
    public function edit(int $id)
    {
        ...
        $code = "SUCCESS";
        try {
            $tableData = $this->service->findCropTypeById($id);
            ...
            $data =  [
                ...
                // 'title' => 'Agriculture Crop Type',
                   'fields' => $data,
                   'formStoreUrl' => "{$this->baseUrl}agri/crop-type/$id",
                ]
            ];
        } catch (AuthenticationException $e) {
            $code = "HTTP_AUTHENTICATION_ERROR";
     ...
     *
     *@link http://api/v1/agri/crop-type/update/id
     *
     *@method PATCH/PUT
     *
     * @param CropTypeRequest  $request The request object
    ...
    */
    public function import(BulkInsertRequest $bulkInsertRequest)
    {
        ...
        try {
            ...
            $validation = [
                'name' => 'required|unique:agri_crop_type,name',
            ];
            ...
            if (!empty($diff)) {
                ...
                $import = new CustomImportsService($this->cropType, $validation);
                $import->import($file);
            }
        } catch (ValidationException $e) {
            $code = "DATA_NOT_FOUND";
            $collection = (new CustomImportsService($this->cropType, []))->toCollection($file);
            $failures = $e->failures();
            $fileName = $this->cropType->getTable() . '_error.xlsx';
            Excel::store(
            ...
            $path = url("{$version_url}agri/crop-type/download/{$fileName}");
            // return an error
            $bulkInsert = $this->service->getBulkInsertFormFields();
