...
use App\Http\Masters\Agri\Services\ParameterService;
...
class ParameterController extends Controller
{
    ...
    */
    ...
    /**
     * Injects Parameter Service dependency through the constructor
     *
     * @param ParameterService $service
     *
     * @return Void
     */
    public function __construct(ParameterService $service,Parameter $parameter)
    {
     ...
     *
     *@link http://api/v1/agri/parameter
     *
     *@method GET
     *
    ...
    /**
     * Displays a form to add new Parameter
     *
     *@link http://api/v1/agri/parameter/create/
     *
     *@method GET
     *
     * @return Response
    ...
    public function create()
    {
        ...
        try{
             $data = [
                'formData' => [
                    //'type' => 'Add',
                    //'title' => 'Add Agriculture Parameter',
                    'fields' => $this->service->getFormFields(),
                    'formStoreUrl' => $this->baseUrl . 'agri/parameter',
                ],
     ...
     *
     *@link http://api/v1/agri/parameter/store
     *
     *@method POST
     *
    ...
    public function store(ParameterRequest $request)
    {
     ...
     /**
     * Displays a form with values to update Parameter
     *
     *@link http://api/v1/agri/parameter/edit/id
     *
     *@method GET
     *
     * @return Response
    ...
    public function edit(int $id)
    {
        ...
        $code = "SUCCESS";
        try {
            $tableData = $this->service->findParameterById($id);
            ...
            $data =  [
                ...
                // 'type' => 'Edit',
                // 'methodName' => 'PUT',
                // 'title' => 'Agriculture Parameter',
                   'fields' => $data,
                   'formStoreUrl' => "{$this->baseUrl}agri/parameter/$id",
                ]
            ];
        } catch (AuthenticationException $e) {
            $code = "HTTP_AUTHENTICATION_ERROR";
     ...
     *
     *@link http://api/v1/agri/parameter/update/id
     *
     *@method PATCH/PUT
     *
     * @param ParameterRequest  $request The request object
    ...
    */
    public function import(BulkInsertRequest $bulkInsertRequest)
    {
        ...
        try {
            ...
            $validation = [
                'name' => 'required|unique:agri_parameter,name',
            ];
            ...
            if (!empty($diff)) {
                ...
                $import = new CustomImportsService($this->parameter, $validation);
                $import->import($file);
            }
        } catch (ValidationException $e) {
            dd($e);
            $code = "DATA_NOT_FOUND";
            $collection = (new CustomImportsService($this->parameter, []))->toCollection($file);
            $failures = $e->failures();
            $fileName = $this->parameter->getTable() . '_error.xlsx';
            Excel::store(
            ...
            $path = url("{$version_url}agri/parameter/download/{$fileName}");
            // return an error
            $bulkInsert = $this->service->getBulkInsertFormFields();
