...
use App\Http\Masters\Agri\Services\CommodityParameterService;
use Symfony\Component\HttpKernel\Exception\NotFoundHttpException;
use Symfony\Component\HttpFoundation\Exception\BadRequestException;

class CommodityParameterController extends Controller
{
    protected $service,$commodityParameter;
    ...
    */
    ...
    /**
     * Injects CommodityParameter Service dependency through the constructor
     *
     * @param CommodityParameterService $service
     *
     * @return Void
     */
    public function __construct(CommodityParameterService $service,CommodityParameter $commodityParameter)
    {
     ...
     *
     *@link http://api/v1/agri/commodity-parameter
     *
     *@method GET
     *
    ...
    /**
     * Displays a form to add new CommodityParameter
     *
     *@link http://api/v1/agri/commodity-parameter/create/
     *
     *@method GET
     *
     * @return Response
    ...
    public function create()
    {
        ...
        try{
             $data = [
                'formData' => [
                    //'type' => 'Add',
                    //'title' => 'Add Agriculture Commodity Parameter',
                    'fields' => $this->service->getFormFields(),
                    'formStoreUrl' => $this->baseUrl . 'agri/commodity-parameter',
                ],
     ...
     *
     *@link http://api/v1/agri/commodity-parameter/store
     *
     *@method POST
     *
     ...
     */
    public function store(CommodityParameterRequest $request)
    {
        $data = null;
        $code = "SUCCESS";
        try {
     ...
     /**
     * Displays a form with values to update CommodityParameter
     *
     *@link http://api/v1/agri/commodity-parameter/edit/id
     *
     *@method GET
     *
     * @return Response
    ...
    public function edit(int $id)
    {
        ...
        $code = "SUCCESS";
        try {
            $tableData = $this->service->findCommodityParameterById($id);
            ...
            $data =  [
                ...
                // 'type' => 'Edit',
                // 'methodName' => 'PUT',
                // 'title' => 'Agriculture Commodity Parameter',
                   'fields' => $data,
                   'formStoreUrl' => "{$this->baseUrl}agri/commodity-parameter/$id",
                ]
            ];
        } catch (AuthenticationException $e) {
            $code = "HTTP_AUTHENTICATION_ERROR";
     ...
     *
     *@link http://api/v1/agri/commodity-parameter/update/id
     *
     *@method PATCH/PUT
     *
     * @param CommodityParameterRequest  $request The request object
    ...
    public function import(BulkInsertRequest $bulkInsertRequest)
    {
        ...
        try {
            ...
            $validation = [
                ...
                'parameter_id\.agri_parameter\.name' => 'required|exists:agri_parameter,name'
            ];
            ...
            if (!empty($diff)) {
                ...
                $import = new CustomImportsService($this->commodityParameter, $validation);
                $import->import($file);
            }
        } catch (ValidationException $e) {
            $code = "DATA_NOT_FOUND";
            $collection = (new CustomImportsService($this->commodityParameter, []))->toCollection($file);
            $failures = $e->failures();
            $fileName = $this->commodityParameter->getTable() . '_error.xlsx';
            Excel::store(
