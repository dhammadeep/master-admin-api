...
use App\Http\Masters\Agri\Services\CommodityModelService;
use Symfony\Component\HttpKernel\Exception\NotFoundHttpException;
use Symfony\Component\HttpFoundation\Exception\BadRequestException;

class CommodityModelController extends Controller
{
    protected $service,$commodityModel;
    ...
    */
    ...
    /**
     * Injects CommodityModel Service dependency through the constructor
     *
     * @param CommodityModelService $service
     *
     * @return Void
     */
    public function __construct(CommodityModelService $service,CommodityModel $commodityModel)
    {
     ...
     *
     *@link http://api/v1/agri/commodity-model
     *
     *@method GET
     *
    ...
    /**
     * Displays a form to add new CommodityModel
     *
     *@link http://api/v1/agri/commodity-model/create/
     *
     *@method GET
     *
     * @return Response
    ...
    public function create()
    {
        ...
        try{
             $data = [
                'formData' => [
                    //'type' => 'Add',
                    //'title' => 'Add Agriculture Commodity Model',
                    'fields' => $this->service->getFormFields(),
                    'formStoreUrl' => $this->baseUrl . 'agri/commodity-model',
                ],
     ...
     *
     *@link http://api/v1/agri/commodity-model/store
     *
     *@method POST
     *
     ...
     */
    public function store(CommodityModelRequest $request)
    {
        $data = null;
        $code = "SUCCESS";
        try {
     ...
     /**
     * Displays a form with values to update CommodityModel
     *
     *@link http://api/v1/agri/commodity-model/edit/id
     *
     *@method GET
     *
     * @return Response
    ...
    public function edit(int $id)
    {
        ...
        $code = "SUCCESS";
        try {
            $tableData = $this->service->findCommodityModelById($id);
            ...
            $data =  [
                ...
                // 'type' => 'Edit',
                // 'methodName' => 'PUT',
                // 'title' => 'Agriculture Commodity Model',
                   'fields' => $data,
                   'formStoreUrl' => "{$this->baseUrl}agri/commodity-model/$id",
                ]
            ];
        } catch (AuthenticationException $e) {
            $code = "HTTP_AUTHENTICATION_ERROR";
     ...
     *
     *@link http://api/v1/agri/commodity-model/update/id
     *
     *@method PATCH/PUT
     *
     * @param CommodityModelRequest  $request The request object
    ...
    */
    public function import(BulkInsertRequest $bulkInsertRequest)
    {
        ...
        try {
            ...
            $validation = [
                'name' => 'required|unique:agri_commodity_model,name'
            ];
            ...
            if (!empty($diff)) {
                ...
                $import = new CustomImportsService($this->commodityModel, $validation);
                $import->import($file);
            }
        } catch (ValidationException $e) {
            $code = "DATA_NOT_FOUND";
            $collection = (new CustomImportsService($this->commodityModel, []))->toCollection($file);
            $failures = $e->failures();
            $fileName = $this->commodityModel->getTable() . '_error.xlsx';
            Excel::store(
