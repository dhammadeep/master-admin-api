...
use App\Http\Masters\Menu\Services\SubMenuService;
...
class SubMenuController extends Controller
{
    ...
    */
    ...
    /**
     * Injects SubMenu Service dependency through the constructor
     *
     * @param SubMenuService $service
     *
     * @return Void
     */
     ...
     *
     *@link http://api/v1/menu/sub-menu
     *
     *@method GET
     *
    ...
    /**
     * Displays a form to add new SubMenu
     *
     *@link http://api/v1/menu/sub-menu/create/
     *
     *@method GET
     *
     * @return Response
        ...
        try{
             $data = [
                'formData' => [
                    ...
                    'formStoreUrl' => $this->baseUrl . 'menu/sub-menu',
                ],
                'bulkInsert' => []
            ];
        } catch (AuthenticationException $e) {
     ...
     *
     *@link http://api/v1/menu/sub-menu/store
     *
     *@method POST
     *
    ...
    public function store(SubMenuRequest $request)
    {
     ...
     /**
     * Displays a form with values to update SubMenu
     *
     *@link http://api/v1/menu/sub-menu/edit/id
     *
     *@method GET
     *
     * @return Response
    ...
    public function edit(int $id)
    {
        ...
        $code = "SUCCESS";
        try {
            $tableData = $this->service->findSubMenuById($id);
            ...
            $data =  [
                ...
                // 'title' => 'SubMenu',
                   'fields' => $data,
                   'formStoreUrl' => "{$this->baseUrl}menu/sub-menu/$id",
                ]
            ];
        } catch (AuthenticationException $e) {
            $code = "HTTP_AUTHENTICATION_ERROR";
     ...
     *
     *@link http://api/v1/menu/sub-menu/update/id
     *
     *@method PATCH/PUT
     *
     * @param SubMenuRequest  $request The request object
