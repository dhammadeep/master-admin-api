...
namespace App\Http\Modules\Gen\Controllers;
...
use App\Http\Modules\Gen\Services\MenuService;
...
class MenuController extends Controller
{
    ...
    */
    private string $baseUrl = "/api/v1/gen/menu";
     ...
     * @return Response
     */
    public function getMenuWithActivity(Request $request)
    {
        $data = null;
        $code = "SUCCESS";
        try{
            $data =  $this->service->getAllPaginatedMenuData($request);
        } catch (AuthenticationException $e) {
            $code = "HTTP_AUTHENTICATION_ERROR";
        } catch (NotFoundHttpException $e) {
            $code = "HTTP_REQUEST_FAILURE";
     ...
     *
     *@link http://api/v1/gen/menu/create/
     *
     *@method GET
     *
     * @return Response
     ...
     *
     *@link http://api/v1/gen/menu/store
     *
     *@method POST
     *
     ...
     *
     *@link http://api/v1/gen/menu/edit/id
     *
     *@method GET
     *
     * @return Response
     ...
     *
     *@link http://api/v1/gen/menu/update/id
     *
     *@method PATCH/PUT
     *
     ...
     * @return \Illuminate\Http\RedirectResponse
     */
    public function saveMenuWithOrder(Request $request)
    {
        $data = null;
        $code = "SUCCESS";
        try {
            $this->service->saveMenuOrder(data: $request);
        } catch (AuthenticationException $e) {
            $code = "HTTP_AUTHENTICATION_ERROR";
        } catch (NotFoundHttpException $e) {
            $code = "HTTP_REQUEST_FAILURE";
