...
class CaseListInitialVisitFarmer extends Model
{
    use HasFactory;
     ...
     * @var string
     */
    protected $table = 'drk_case_list_initial_visit_for_farmer';
     ...
     * @return array
     */
    public static function getFilterFields($extraFields = []): array
    {
