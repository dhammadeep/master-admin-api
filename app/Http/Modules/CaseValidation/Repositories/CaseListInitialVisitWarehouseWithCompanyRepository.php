...
use App\Http\Modules\CaseValidation\Repositories\RepoInterface\CaseListInitialVisitWarehouseWithCompanyRepoInterface;

class CaseListInitialVisitWarehouseWithCompanyRepository implements CaseListInitialVisitWarehouseWithCompanyRepoInterface
{
    /**
    ...
    public function getList(Request $request, int $rowsPerPage, CaseListRequest $dto)
    {
        ...
        try {
            ...
            $query = CaseListInitialVisitWarehouseWithCompany::query()
                ->select(
                    'case_id',
                    'crop_type',
                    'user_full_name',
    ...
    {
        try {
            return CaseListInitialVisitWarehouseWithCompany::getTableFields();
        } catch (Exception $e) {
            throw $e;
        }
    }
    ...
    public function listCropType(CaseListRequest $caseListOptions)
    {
        ...
        try {
            $query =  CaseListInitialVisitWarehouseWithCompany::select('crop_type_id', 'crop_type')
