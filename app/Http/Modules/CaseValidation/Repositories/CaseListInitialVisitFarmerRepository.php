...
use App\Http\Modules\CaseValidation\Repositories\RepoInterface\CaseListInitialVisitFarmerRepoInterface;

class CaseListInitialVisitFarmerRepository implements CaseListInitialVisitFarmerRepoInterface
{
    /**
     ...
     */
    public function getList(Request $request, int $rowsPerPage, CaseListRequest $caseListOptions, $ownershipType = '')
    {
        ...
        try {
            ...
            $query = CaseListInitialVisitFarmer::query()
                ->select(
                    'case_id',
                    'crop_type',
                    'user_full_name',
    ...
    {
        try {
            return CaseListInitialVisitFarmer::getTableFields();
        } catch (Exception $e) {
            throw $e;
        }
    }
    ...
    public function listCropType(CaseListRequest $caseListOptions)
    {
        ...
        try {
            $query =  CaseListInitialVisitFarmer::select('crop_type_id', 'crop_type')
