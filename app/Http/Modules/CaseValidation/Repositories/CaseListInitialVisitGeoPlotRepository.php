...
use App\Http\Modules\CaseValidation\Repositories\RepoInterface\CaseListInitialVisitGeoPlotRepoInterface;

class CaseListInitialVisitGeoPlotRepository implements CaseListInitialVisitGeoPlotRepoInterface
{
    /**
    ...
    public function getList(Request $request, int $rowsPerPage, CaseListRequest $dto)
    {
        ...
        try {
            ...
            $query = CaseListInitialVisitGeoPlot::query()
                ->select(
                    'case_id',
                    'crop_type',
                    'user_full_name',
    ...
    {
        try {
            return CaseListInitialVisitGeoPlot::getTableFields();
        } catch (Exception $e) {
            throw $e;
        }
    }
    ...
    public function listCropType(CaseListRequest $caseListOptions)
    {
        ...
        try {
            $query =  CaseListInitialVisitGeoPlot::select('crop_type_id', 'crop_type')
