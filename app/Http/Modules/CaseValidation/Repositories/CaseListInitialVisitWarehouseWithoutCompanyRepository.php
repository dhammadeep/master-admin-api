...
use App\Http\Modules\CaseValidation\Repositories\RepoInterface\CaseListInitialVisitWarehouseWithoutCompanyRepoInterface;

class CaseListInitialVisitWarehouseWithoutCompanyRepository implements CaseListInitialVisitWarehouseWithoutCompanyRepoInterface
{
    /**
    ...
    public function getList(Request $request, int $rowsPerPage, CaseListRequest $dto)
    {
        ...
        try {
            ...
            $query = CaseListInitialVisitWarehouseWithoutCompany::query()
                ->select(
                    'case_id',
                    'crop_type',
                    'user_full_name',
    ...
    {
        try {
            return CaseListInitialVisitWarehouseWithoutCompany::getTableFields();
        } catch (Exception $e) {
            throw $e;
        }
    }
    ...
    public function listCropType(CaseListRequest $caseListOptions)
    {
        ...
        try {
            $query =  CaseListInitialVisitWarehouseWithoutCompany::select('crop_type_id', 'crop_type')
